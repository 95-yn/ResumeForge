...
export default function LandingPage() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Old+Standard+TT:ital,wght@0,400;0,700;1,400&family=JetBrains+Mono:wght@400;500&display=swap');
      ...
      <div className="lp-root">
        ...
        <nav className="lp-nav">
          <Link href="/landing" className="lp-nav-logo">RF · ResumeForge</Link>
          <Link href="/" className="lp-nav-cta">开始创建 →</Link>
        </nav>
        ...
        <section className="lp-cta">
          ...
          <div className="lp-cta-right">
            ...
            <Link href="/" className="lp-cta-link display" tabIndex={0}>
        ...
        <footer className="lp-footer">
          ...
          <span className="lp-footer-meta">
            <Link href="/" className="lp-footer-link">Template Market</Link>
            &nbsp;·&nbsp;
