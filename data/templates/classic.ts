...
const template: TemplateData = {
  ...
  <section class="section" data-section="experience"><h2 class="section-title"><span class="sec-num">02</span><span class="sec-label">工作经历</span></h2>
    {{#each experience}}
  ...
  {{/if}}
  {{#if education.length}}
  <section class="section" data-section="education"><h2 class="section-title"><span class="sec-num">03</span><span class="sec-label">教育背景</span></h2>
  ...
  {{/if}}
  {{#if projects.length}}
  <section class="section" data-section="projects"><h2 class="section-title"><span class="sec-num">05</span><span class="sec-label">项目经历</span></h2>
...
@media print { .resume.classic { margin: 0; }
