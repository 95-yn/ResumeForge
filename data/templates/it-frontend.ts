...
const template: TemplateData = {
  ...
  {{#if basics.summary}}
  <section class="section"><h2 class="section-title"><span class="sq"></span><span data-field-text>个人简介</span></h2><div class="summary" data-field="basics.summary">{{{basics.summary}}}</div></section>
  {{/if}}
  {{#if experience.length}}
  <section class="section" data-section="experience"><h2 class="section-title"><span class="sq"></span><span data-field-text>工作经历</span></h2>
    {{#each experience}}
  ...
  {{/if}}
  {{#if education.length}}
  <section class="section" data-section="education"><h2 class="section-title"><span class="sq"></span><span data-field-text>教育背景</span></h2>
...
@media print { .resume.it-frontend { margin: 0; }
