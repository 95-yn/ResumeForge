...
.resume.hr-recruiter .resume-header h1::after {
  content: "";
  display: block;
  width: 28px;
  height: 2px;
...
.resume.hr-recruiter .section-title::before {
  counter-increment: hrsec;
  content: counter(hrsec, decimal-leading-zero);
  font-size: 8pt;
  font-weight: 700;
  color: #B45309;
  letter-spacing: 1px;
...
@media print { .resume.hr-recruiter { margin: 0; }
