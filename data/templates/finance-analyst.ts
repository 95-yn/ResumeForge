...
const template: TemplateData = {
  ...
  {{#if basics.summary}}
  <section class="section"><h2 class="section-title"><span class="st-no">01</span><span class="st-txt">个人简介</span></h2><div class="summary" data-field="basics.summary">{{{basics.summary}}}</div></section>
  {{/if}}
  {{#if experience.length}}
  <section class="section" data-section="experience"><h2 class="section-title"><span class="st-no">02</span><span class="st-txt">工作经历</span></h2>
    {{#each experience}}
  ...
  {{/if}}
  {{#if education.length}}
  <section class="section" data-section="education"><h2 class="section-title"><span class="st-no">03</span><span class="st-txt">教育背景</span></h2>
  ...
  {{/if}}
  {{#if skills.length}}
  <section class="section" data-section="skills"><h2 class="section-title"><span class="st-no">04</span><span class="st-txt">专业技能</span></h2><div class="skill-tags">{{#each skills}}<span class="tag" data-entry="skills" data-entry-index="{{@index}}"><span data-field="skills.{{@index}}.name">{{{name}}}</span>{{#if level}} · <span data-field="skills.{{@index}}.level">{{{level}}}</span>{{/if}}</span>{{/each}}</div></section>
  {{/if}}
  {{#if projects.length}}
  <section class="section" data-section="projects"><h2 class="section-title"><span class="st-no">05</span><span class="st-txt">项目经历</span></h2>
...
.resume.finance-analyst .section { margin-bottom: 15px; }
...
.resume.finance-analyst .entry { margin-bottom: 9px; }
