...
const template: TemplateData = {
  ...
  {{#if basics.summary}}
  <section class="section"><h2 class="section-title"><span class="sec-num">01</span><span class="sec-label">个人简介</span></h2><div class="summary" data-field="basics.summary">{{{basics.summary}}}</div></section>
  {{/if}}
  {{#if education.length}}
  <section class="section" data-section="education"><h2 class="section-title"><span class="sec-num">02</span><span class="sec-label">教育背景</span></h2>
  ...
  {{/if}}
  {{#if projects.length}}
  <section class="section" data-section="projects"><h2 class="section-title"><span class="sec-num">03</span><span class="sec-label">项目经历</span></h2>
  ...
  {{/if}}
  {{#if skills.length}}
  <section class="section" data-section="skills"><h2 class="section-title"><span class="sec-num">04</span><span class="sec-label">专业技能</span></h2><div class="skill-tags">{{#each skills}}<span class="tag" data-entry="skills" data-entry-index="{{@index}}"><span data-field="skills.{{@index}}.name">{{{name}}}</span>{{#if level}} · <span data-field="skills.{{@index}}.level">{{{level}}}</span>{{/if}}</span>{{/each}}</div></section>
  {{/if}}
  {{#if experience.length}}
  <section class="section" data-section="experience"><h2 class="section-title"><span class="sec-num">05</span><span class="sec-label">实习经历</span></h2>
    {{#each experience}}
...
@media print { .resume.campus-general { margin: 0; }
