...
.mn-header h1 { font-size: 26pt; font-weight: 800; color: #171717; letter-spacing: -0.5px; line-height: 1.05; }
.mn-title { font-size: 10.5pt; font-weight: 400; color: #737373; margin-top: 5px; }
.mn-contacts { margin-top: 8px; display: flex; gap: 14px; flex-wrap: wrap; font-size: 9pt; color: #A3A3A3; }
.mn-section { margin-bottom: 15px; }
.mn-heading { position: relative; font-size: 8.5pt; font-weight: 800; color: #171717; text-transform: uppercase; letter-spacing: 2px; margin-bottom: 9px; padding-left: 14px; }
.mn-heading::before { content: ''; position: absolute; left: 0; top: 50%; transform: translateY(-50%); width: 6px; height: 6px; background: #171717; border-radius: 50%; }
.mn-entry { margin-bottom: 10px; }
.mn-row { display: flex; justify-content: space-between; align-items: baseline; }
.mn-strong { font-size: 11pt; font-weight: 700; color: #171717; }
...
.mn-tag { font-size: 9pt; color: #404040; border: 1px solid #D4D4D4; padding: 2px 10px; border-radius: 3px; }
