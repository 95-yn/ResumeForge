...
const template: TemplateData = {
  ...
  <section class="sp-section">
    <h2 class="sp-heading"><span class="sp-idx">00</span>Summary</h2>
    <div class="sp-body" data-field="basics.summary">{{{basics.summary}}}</div>
  </section>
  {{/if}}
  {{#if experience.length}}
  <section class="sp-section" data-section="experience">
    <h2 class="sp-heading"><span class="sp-idx">01</span>Experience</h2>
    {{#each experience}}
  ...
  <section class="sp-section" data-section="education">
    <h2 class="sp-heading"><span class="sp-idx">02</span>Education</h2>
    {{#each education}}
  ...
  <section class="sp-section" data-section="skills">
    <h2 class="sp-heading"><span class="sp-idx">03</span>Skills</h2>
    <div class="sp-skills">
  ...
  <section class="sp-section" data-section="projects">
    <h2 class="sp-heading"><span class="sp-idx">04</span>Projects</h2>
    {{#each projects}}
...
.sp-header { margin-bottom: 34px; }
.sp-header h1 { font-size: 27pt; font-weight: 300; color: #111; letter-spacing: 3px; line-height: 1.2; }
.sp-title { font-size: 11pt; color: #888; margin-top: 6px; letter-spacing: 0.5px; }
.sp-contacts { margin-top: 12px; padding-top: 12px; border-top: 1px solid #eee; display: flex; gap: 20px; flex-wrap: wrap; font-size: 9.5pt; color: #999; }
.sp-section { margin-bottom: 30px; }
/* signature: a tabular section index paired with the label, ultra-restrained mono accent */
.sp-heading { display: flex; align-items: baseline; gap: 12px; font-size: 8.5pt; font-weight: 500; text-transform: uppercase; letter-spacing: 4px; color: #999; margin-bottom: 16px; }
.sp-idx { font-family: "Helvetica Neue", Arial, sans-serif; font-size: 8.5pt; font-weight: 600; letter-spacing: 1px; color: #111; padding-right: 12px; border-right: 1px solid #ddd; }
.sp-entry { margin-bottom: 22px; }
...
.sp-date { font-size: 9.5pt; color: #aaa; }
...
@media print { .resume.space { margin: 0; }
