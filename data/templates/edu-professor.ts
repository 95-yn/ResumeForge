...
/* Signature: serif Roman-numeral-style section index with diamond rule */
...
.resume.edu-professor .section-title::before {
  counter-increment: ep-sec;
  content: counter(ep-sec) ".";
  font-family: Georgia, 'Times New Roman', 'SimSun', serif;
  font-style: italic;
  font-weight: 400;
  font-size: 11pt;
...
@media print { .resume.edu-professor { margin: 0; }
