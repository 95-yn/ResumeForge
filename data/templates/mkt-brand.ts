...
/* Signature: editorial masthead — brand accent block + oversized name */
...
.resume.mkt-brand .resume-header::before {
  content: "";
  display: block;
  width: 36px;
  height: 7px;
...
.resume.mkt-brand .contact-item { margin: 0 8px 0 0; }
...
.resume.mkt-brand .section { margin-bottom: 14px; }

/* Signature: section heading led by a small crimson brand square */
...
.resume.mkt-brand .section-title::before {
  content: "";
  width: 7px;
  height: 7px;
  margin-right: 9px;
...
@media print { .resume.mkt-brand { margin: 0; }
