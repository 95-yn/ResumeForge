...
.resume.legal-compliance .section { margin-bottom: 13px; }
...
.resume.legal-compliance .section-title::before {
  content: "";
  position: absolute;
  left: 0; top: 50%;
...
.resume.legal-compliance .separator { color: #94A3B8; }
...
@media print { .resume.legal-compliance { margin: 0; }
