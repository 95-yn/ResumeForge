...
.resume.legal-ip .section { margin-bottom: 13px; }
...
.resume.legal-ip .section-title::before {
  counter-increment: ipsec;
  content: "§" counter(ipsec);
  font-size: 9pt;
  font-weight: 700;
  color: #78716C;
  letter-spacing: 0;
...
@media print { .resume.legal-ip { margin: 0; }
