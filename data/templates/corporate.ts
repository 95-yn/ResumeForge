...
const template: TemplateData = {
  ...
  <section class="corp-section">
    <h2 class="corp-section-title"><span class="corp-num">01</span>职业概述</h2>
    <div class="corp-body" data-field="basics.summary">{{{basics.summary}}}</div>
  </section>
  {{/if}}
  {{#if experience.length}}
  <section class="corp-section" data-section="experience">
    <h2 class="corp-section-title"><span class="corp-num">02</span>工作经历</h2>
    {{#each experience}}
  ...
  <section class="corp-section" data-section="education">
    <h2 class="corp-section-title"><span class="corp-num">03</span>教育背景</h2>
    {{#each education}}
  ...
  <section class="corp-section" data-section="skills">
    <h2 class="corp-section-title"><span class="corp-num">04</span>专业技能</h2>
  ...
  <section class="corp-section" data-section="projects">
    <h2 class="corp-section-title"><span class="corp-num">05</span>项目经历</h2>
    {{#each projects}}
...
.corp-header { background: #1E3A5F; color: #fff; padding: 15mm 22mm 11mm; border-bottom: 3px solid #C9A227; }
.corp-header h1 { font-size: 21pt; font-weight: 700; letter-spacing: 1.5px; color: #fff; }
.corp-title { font-size: 10.5pt; color: rgba(255,255,255,0.82); margin-top: 4px; letter-spacing: 0.5px; }
.corp-contacts { margin-top: 9px; display: flex; gap: 18px; flex-wrap: wrap; }
.corp-contact { font-size: 9pt; color: rgba(255,255,255,0.85); }
.corp-section { padding: 0 22mm; margin-top: 14px; }
.corp-section-title { display: flex; align-items: baseline; gap: 8px; font-size: 9.5pt; font-weight: 700; color: #1E3A5F; letter-spacing: 1.5px; border-bottom: 1px solid #CBD5E1; padding-bottom: 4px; margin-bottom: 8px; }
.corp-num { font-size: 8pt; font-weight: 700; color: #C9A227; letter-spacing: 0.5px; font-feature-settings: "tnum"; }
...
.corp-skill-level { color: #1E3A5F; font-size: 9pt; }
li p, li div { margin: 0; padding: 0; display: inline; }
@media print { .resume.corporate { margin: 0; } }
